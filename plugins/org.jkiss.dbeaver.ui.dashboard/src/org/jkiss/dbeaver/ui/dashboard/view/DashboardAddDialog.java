...
public class DashboardAddDialog extends BaseDialog {
    ...
    public DashboardAddDialog(Shell parentShell, DashboardViewConfiguration viewConfiguration) {
        super(parentShell, UIDashboardMessages.add_dialog_dashboard_add_dashboard, null);
...
//        listViewer.getControl().setLayoutData(new GridData(GridData.FILL_BOTH));
        ...
        UIUtils.createTableColumn(table, SWT.LEFT, UIDashboardMessages.add_dialog_dashboard_name); 
        UIUtils.createTableColumn(table, SWT.LEFT, UIDashboardMessages.add_dialog_dashboard_desc);
        ...
        table.addPaintListener(e -> {
            if (table.getItemCount() == 0) {
                UIUtils.drawMessageOverControl(table, e, UIDashboardMessages.add_dialog_dashboard_no_more_panels + viewConfiguration.getDataSourceContainer().getDriver().getName(), 0);
            }
        });
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        ...
        final Button managerButton = createButton(parent, IDialogConstants.CANCEL_ID, UIDashboardMessages.add_dialog_dashboard_manage, false);
        ...
        createButton(parent, IDialogConstants.OK_ID, UIDashboardMessages.add_dialog_dashboard_add_button, true).setEnabled(false);
        createButton(parent, IDialogConstants.CANCEL_ID, UIDashboardMessages.add_dialog_dashboard_cancel_button, /*IDialogConstants.CANCEL_LABEL,*/ false);
    }
