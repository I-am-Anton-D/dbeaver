...
public class DashboardEditDialog extends BaseDialog {
    ...
    {
        super(shell, UIDashboardMessages.edit_dialog_dashboard_dashboard + " [" + dashboardDescriptor.getName() + "]", null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        if (readOnly) {
            UIUtils.createInfoLabel(composite, UIDashboardMessages.edit_dialog_dashboard_predifened_dashbords_read_only);
        }

        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.edit_dialog_dashboard_main_info, 4, GridData.FILL_HORIZONTAL, 0);

            idText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.edit_dialog_dashboard_id, dashboardDescriptor.getId(), SWT.BORDER | baseStyle);
            ...
            nameText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.edit_dialog_dashboard_name, dashboardDescriptor.getName(), SWT.BORDER | baseStyle);
            ...
            {
                UIUtils.createControlLabel(infoGroup, UIDashboardMessages.add_dialog_dashboard_database);
                ...
                UIUtils.createPushButton(dbSelectorPanel, UIDashboardMessages.edit_dialog_dashboard_select, null, new SelectionAdapter() {
                    @Override
...
//                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));
            dataTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboard_data_type, UIDashboardMessages.edit_dialog_dashboard_type_of_data, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            calcTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboard_calc_type, UIDashboardMessages.edit_dialog_dashboard_value_calculation_type, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            valueTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboard_value_type, UIDashboardMessages.edit_dialog_dashboard_type_of_values, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            intervalCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboard_interval, UIDashboardMessages.edit_dialog_dashboard_interval_values, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            fetchTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboard_fetch_type, UIDashboardMessages.edit_dialog_dashboard_fetch_type_values, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            descriptionText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.edit_dialog_dashboard_desc, CommonUtils.notEmpty(dashboardDescriptor.getDescription()), SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL | baseStyle);
        ...
        {
            Group sqlGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.edit_dialog_dashboard_queries, 1, GridData.FILL_BOTH, 0);
            queryText = new Text(sqlGroup, SWT.BORDER | SWT.MULTI | SWT.V_SCROLL | SWT.WRAP | baseStyle);
            GridData gd = new GridData(GridData.FILL_BOTH);
            gd.heightHint = 100;
            gd.widthHint = 400;
            queryText.setLayoutData(gd);
            UIUtils.createInfoLabel(sqlGroup, UIDashboardMessages.edit_dialog_dashboard_use_blank_line);
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.edit_dialog_dashboard_rendering, 2, GridData.FILL_HORIZONTAL, 0);

            viewTypeCombo = UIUtils.createLabelCombo(updateGroup, UIDashboardMessages.edit_dialog_dashboard_defatul_view, UIDashboardMessages.edit_dialog_dashboard_dashboard_view, SWT.BORDER | SWT.READ_ONLY);
            ...
            updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.edit_dialog_dashboard_update_period, String.valueOf(dashboardDescriptor.getUpdatePeriod()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
            maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.edit_dialog_dashboard_maximum_items, String.valueOf(dashboardDescriptor.getMaxItems()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
